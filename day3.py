...
def crosspoint_finder(data_a,data_b):
    intersection_points = []
    distances = []
        ...
        for  b_line in data_b:
                ...
                if ax1==ax2 and by1==by2:
                    if (bx1>=ax1>bx2 or bx1<ax1<bx2) and (ay1<=by1<=ay2 or ay1>=by1>=ay2):
                        ...
                        continue
                elif bx1==bx2 and ay1==ay2:
                    if (ax1>=bx1>ax2 or ax1<=bx1<=ax2) and(by1<=ay2<=by2 or by1>=ay2>=by2):
                        distance = abs(bx1)+abs(ay1)
                        intersect = [bx1,ay1]
                        if distance!=0:
                            distances.append(distance)
                            intersection_points.append(intersect)
                    ...
                    continue
    return distances , intersection_points 
# %%
def step_counter(data, intersection_points):
    cumulative=[]
